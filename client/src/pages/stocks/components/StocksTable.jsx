        ...
        <>
            <div className="tw-flex tw-items-center tw-justify-between tw-px-4">
                ...
                <div className="tw-flex tw-items-center tw-space-x-5">
                    <Link to={`/stocks/report`} className="tw-flex tw-items-center tw-space-x-2 tw-border tw-border-red-500 tw-rounded-lg tw-px-2 tw-cursor-pointer hover:tw-bg-red-100 tw-py-1 tw-text-red-700">
